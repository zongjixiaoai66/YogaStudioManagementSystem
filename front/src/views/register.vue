    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">瑜伽馆管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="身份证号" class="input" v-if="tableName=='jiaolian'">
                            <el-input v-model="ruleForm.jiaolianIdNumber" autocomplete="off" placeholder="身份证号"  />
                        </el-form-item>
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yujiaguanyuyue/img/back-img-bg.jpg);
