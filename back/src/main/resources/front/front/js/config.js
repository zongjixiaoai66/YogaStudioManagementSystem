...
var centerMenu = [
    ...
    ,{
        name: '套餐购买',
        url: '../taochanOrder/list.html'
    }
    ,{
        name: '体测报告',
        url: '../ticebaogao/list.html'
    }
    ,{
        name: '瑜伽预约',
        url: '../yujiaOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '套餐',
        url: './pages/taochan/list.html'
    },
    {
        name: '瑜伽',
        url: './pages/yujia/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/yujiaguanyuyue/admin/dist/index.html#/login";
